...
| L1 | growth_plate_architecture | 48 | 21 (43%) | 20 (41%) | 25 (52%) | 15 | 4/11 | **40** |
...
| L5 | matrix_and_mineralization | 43 | 18 (41%) | 12 (27%) | 14 (32%) | 18 | 4/19 | **100** |
...
| L12 | pharmacology_as_mechanistic_probe | 39 | 31 (79%) | 27 (69%) | 8 (20%) | 31 | 16/10 | **50** |
| L13 | methods_and_data | 41 | 19 (46%) | 13 (31%) | 15 (36%) | 14 | 11/18 | **50** |
| | **TOTAL** | **620** | **355 (57.3%)** | **249 (40.2%)** | | **292** | | **64.0** |
...
| | |
|---|---|
| Nodes | 620 (620 researched, 0 stubs) |
...
|---|---:|---:|---:|---:|
| zone | 639/1196 | 53.4% | 549 (45.9%) | 40% |
| sex | 365/1196 | 30.5% | 827 (69.1%) | 30% |
| stage | 764/1196 | 63.9% | 427 (35.7%) | 40% |
| species | 1147/1196 | 95.9% | 41 (3.4%) | — |
...
| definitional — an endpoint node **is** a zone | 315 | 26.3% |
| **inferred from endpoint localization records** | **261** | **21.8%** |
| → strong (source-resolved + definitional) | 378 | 31.6% |

Sign coverage on sign-bearing relations is the traversal gate and stands at **786/786 = 100%**. The 410 excluded edges are `precedes` (temporal), `binds` (no direction), `correlates_with` and `hypothesized_link` — signing them would be fabrication, so they are flagged `traversal_usable: false` rather than traversed.
<!-- COVERAGE:STRUCT:END -->
