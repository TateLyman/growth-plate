...
<!-- DASHBOARD:BEGIN -->
**Totals** — 610 nodes (574 researched, 36 stubs) ·
576 edges · 131 gaps (68 search logs) · 684 references
...
|---|---|---:|---:|---:|---:|:--:|:--:|:--:|
| L0 | developmental_origin | 25 | 25 | 0 | 0 | 0/8·0/3 | — | ✅ |
...
| L9 | whole_organism_growth | 33 | 33 | 0 | 0 | 0/8·0/3 | — | — |
| L10 | environment_and_population | 34 | 34 | 0 | 0 | 0/8·0/3 | — | — |
| L11 | pathology_as_natural_experiment | 56 | 56 | 38 | 25 | ✅ | — | ✅ |
| L12 | pharmacology_as_mechanistic_probe | 35 | 35 | 1 | 2 | 2/8·2/3 | — | — |
| L13 | methods_and_data | 41 | 39 | 0 | 2 | 2/8·2/3 | — | — |
| | **total** | **610** | **574** | **576** | **131** | | | |

**Confidence distribution** (researched nodes): **A** 141 · **B** 169 · **C** 178 · **D** 73 · **E** 11 · **X** 2

**Gap types**: `contradiction` 14 · `known_unknown` 25 · `method_blocked` 5 · `quantitative_gap` 36 · `scale_gap` 2 · `search_established` 38 · `species_gap` 11

**Quantitative**: 1336 values on nodes · 811 rows in `quant/parameters.csv`
...
| `replicated_human_fraction` — direct human evidence **and** ≥2 human primaries | **36.1%** | — |
| `edges_per_node` | **0.94** | ≥3.0 |
| `refs_per_researched` | **3.06** | ≥3.0 |
| `quant_node_coverage` | **65.7%** | ≥60% |
| `stub_fraction` | **5.9%** | 0% |
