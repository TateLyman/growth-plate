...
| | **total** | **654** | **410** | **576** | **131** | | | |

**Confidence distribution** (researched nodes): **A** 89 · **B** 106 · **C** 151 · **D** 52 · **E** 11 · **X** 1
...
**Quantitative**: 811 values on nodes · 811 rows in `quant/parameters.csv`
...
| metric | value | target |
|---|---:|---:|
| `human_evidence_fraction` — researched nodes with `human_evidence: direct` | **50.0%** | — |
| `replicated_human_fraction` — direct human evidence **and** ≥2 human primaries | **31.7%** | — |
| `edges_per_node` | **0.88** | ≥3.0 |
| `refs_per_researched` | **3.08** | ≥3.0 |
| `quant_node_coverage` | **57.6%** | ≥60% |
| `stub_fraction` | **37.3%** | 0% |
